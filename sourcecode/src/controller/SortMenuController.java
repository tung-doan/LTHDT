    ...
    public static VBox createMenu(List list, Runnable updateVisualization) {
        ...
        ascendingButton.setOnAction(e -> {
            try {
                ...
                AlertUtils.showAlert("Success", "The list has been sorted in ascending order.", Alert.AlertType.INFORMATION);
            } catch (IllegalStateException ex) {
                AlertUtils.showAlert("Error", "The list is empty. Please add elements before sorting.", Alert.AlertType.ERROR);
            }
        });
        ...
        descendingButton.setOnAction(e -> {
            try {
                list.sort(false); 
                updateVisualization.run(); 
                AlertUtils.showAlert("Success", "The list has been sorted in descending order.", Alert.AlertType.INFORMATION);
            } catch (IllegalStateException ex) {
                AlertUtils.showAlert("Error", "The list is empty. Please add elements before sorting.", Alert.AlertType.ERROR);
            }
        });
